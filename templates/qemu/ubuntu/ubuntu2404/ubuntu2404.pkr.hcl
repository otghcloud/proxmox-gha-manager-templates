...
source "qemu" "ubuntu2404" {
  vm_name       = "runner-image-qemu-ubuntu2404"
  headless      = true
  ...
  iso_url      = var.qemu_ubuntu2404_iso_url
  iso_checksum = var.qemu_ubuntu2404_iso_checksum

  output_directory = "output-qemu-ubuntu2404"
  format           = "qcow2"
