...
source "qemu" "ubuntu2604" {
  vm_name       = "runner-image-qemu-ubuntu2604"
  headless      = true
  ...
  iso_url      = var.qemu_ubuntu2604_iso_url
  iso_checksum = var.qemu_ubuntu2604_iso_checksum

  output_directory = "output-qemu-ubuntu2604"
  format           = "qcow2"
...
build {
  sources = ["source.qemu.ubuntu2604"]
