variable "qemu_windows2025_iso_url" {
  type        = string
  description = "Path or URL of the Windows Server 2025 installation ISO used by the QEMU builder"
}

variable "qemu_windows2025_iso_checksum" {
  type        = string
  default     = "none"
