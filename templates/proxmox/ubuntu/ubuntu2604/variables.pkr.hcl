...
variable "pmx_ubuntu2604_iso_file" {
  type        = string
  description = "Proxmox volume ID of the Ubuntu 26.04 Server installation ISO"
}
...
variable "ubuntu_disk_size_gb" {
  ...
  validation {
    ...
    error_message = "Disk size must be at least 100 GB."
  }
}
